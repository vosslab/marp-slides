...
class EditableParagraph:
	...
	inlines: tuple[marp_lib.native_model.Inline, ...]
	level: int
	ordered: bool
	paragraph_only: bool
	start: int
...
class ParagraphRevealRange:
	...
	first_index: int
	last_index: int
	reveal: marp_lib.native_model.Reveal
...
#============================================
def project_list(block: marp_lib.native_model.ListBlock, level: int = 0) -> tuple[EditableParagraph, ...]:
...
#============================================
def item_reveal_ranges(block: marp_lib.native_model.ListBlock, start: int = 0) -> tuple[ParagraphRevealRange, ...]:
...
#============================================
def cascade_ranges(block: marp_lib.native_model.ListBlock) -> tuple[ParagraphRevealRange, ...]:
...
#============================================
def project_block(block: marp_lib.native_model.Heading | marp_lib.native_model.Paragraph |
		marp_lib.native_model.ListBlock) -> EditableTextProjection:
	...
	if isinstance(block, marp_lib.native_model.ListBlock):
		...
		if block.reveal is not None and block.reveal.sequence is marp_lib.native_model.RevealSequence.PARAGRAPHS:
