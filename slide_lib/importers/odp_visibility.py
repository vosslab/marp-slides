...
#============================================
def run_visibility(input_file: pathlib.Path) -> None:
	"""Print each source slide's resolved visible or hidden state."""
	# Import at the operation boundary to avoid a module-level cycle with odp_to_marp.
	...
	slides = odp_to_marp.read_slides(input_file)
	for slide in slides:
